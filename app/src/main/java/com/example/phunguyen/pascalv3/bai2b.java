...
public class bai2b extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams tuaBai2 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        tuaBai2.setMargins(0, 0, 0, 8);
        ...
        tuaBai.addView(khungCauHoi1,tuaBai2);
        //Tao dap an
        final int[] dab1 = {0};
