...
public class bai3b extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams tuaBai3 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        tuaBai3.setMargins(0, 0, 0, 8);
        ...
        LinearLayout khungCauHoi3 = (LinearLayout) View.inflate(this, R.layout.khung_cau_hoi, null);
        //Thay doi noi dung cau hoi
        final ImageView nhanXet = (ImageView) khungCauHoi3.findViewById(R.id.check);
        tuaBai.addView(khungCauHoi3,tuaBai3);
        //Tao dap an
        final int[] dab1 = {0};
